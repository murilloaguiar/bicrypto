...
<html>
  <head>
    <meta charset="utf-8"/>
    <title>Bicrypto Stage 2 : Database Installer</title>
      ...
      <div class="section">
        <div class="columns is-centered">
          <div class="column is-two-fifths">
            <center>
              <h1 class="title" style="padding-top: 20px;">Bicrypto Stage 2 <br/> Database Installer</h1><br>
            </center>
            </center>
            <div class="box">
              <div class='content'>
                <?php if($update_data['status']){ ?>
                <p>Installation of Database might take some time!</p><?php
                  $update_id = null;
                  $has_sql = null;
                  $version = null;
            ...
            <center>
            <a href="./step3.php"><button class="button is-link is-rounded">Step 3</button></a>
            </center>
          </div>
        </div>
      </div>
