<template>
    <div>
        <div v-for="c in coinsList" :key="c.symbol" class="card" :class="c.style">
            <a :href="'/'+urll+c.token" class="stretched-link"></a>
...
export default {
    ...
    // app data
        ...
        methods: {
            updateurll() {
                if(document.location.pathname.indexOf('/user/demo') == 0) {
                    this.urll = 'user/demo/';
                } else if(document.location.pathname.indexOf('/user/real') == 0) {
                    this.urll = 'user/real/';
                } else if(document.location.pathname.indexOf('/user/dashboard/demo') == 0) {
                    this.urll = 'user/demo/';
                } else {
                    this.urll = 'user/real/';
                }
