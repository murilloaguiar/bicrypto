        ...
        <div class="card-body">
                    ...
                    @csrf
                        <div class="form-group mb-1 col-sm-6">
                            ...
                            <input type="text" id="name" name="name" class="form-control cmn--form--control " value="{{$user->fullname}}" readonly>
                        </div>
                        <div class="form-group mb-1 col-sm-6">
                            <label for="email" class="label">{{ __('locale.Email')}}</label>
                            <input type="text" id="email" name="email" class="form-control cmn--form--control " value="{{$user->email}}" readonly>
                        </div>
                        <div class="form-group mb-1 col-sm-12">
                            <label for="subject" class="label">{{ __('locale.Subject')}}</label>
                            <input type="text" id="subject" name="subject" class="form-control cmn--form--control " placeholder="{{ __('locale.Enter Subject')}}" required="">
                        </div>
                        <div class="form-group mb-1 col-sm-12">
                            <label for="message" class="label">{{ __('locale.Message')}}</label>
                            <textarea id="message" name="message" class="form-control cmn--form--control " placeholder="{{ __('locale.Message')}}" required=""></textarea>
                        </div>
                        ...
                        <div class="form-group mb-1 col-sm-12">
                            <div class="d-flex">
                                ...
                                <div class="add-area">
                                    ...
                                    <button class="btn btn-primary btn-sm bg-primary ms-2 ms-md-4 cmn--form--control" onclick="extraTicketAttachment()" type="button"><i class="bi bi-plus"></i></button>
                                </div>
                            </div>
                        </div>
