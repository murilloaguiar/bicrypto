<div class="card">
    ...
    <div class="card-body text-center d-flex justify-content-center align-items-center border-light rounded">
        ...
        <div class="card-body text-center d-flex justify-content-center align-items-center border-warning rounded">
            ...
            <div class="card-body text-center d-flex justify-content-center align-items-center border-info rounded d-flex align-items-center">
                ...
                <div class="card-body text-center d-flex justify-content-center align-items-center border-warning rounded">
                    ...
                    <div class="card-body text-center d-flex justify-content-center align-items-center border-success rounded ">
                        <div class="status-verified">
                            <div class="status-icon d-flex justify-content-center align-items-center">
                                <i class="bi bi-shield-check text-success"></i>
                            </div>
                            <span class="status-text-d text-dark">{{__('Your identity verified successfully.')}}</span>
                            <p class="">
                                {{__('One of our team members verified your identity. Now you can participate in our trading platform. Thank you.')}}
                            </p>
                            <a href="{{ route('user.home.trade') }}" class="btn btn-primary">{{__('Trade Wallet')}}</a>
                        </div>
                        @endif
                    </div>
                </div>
