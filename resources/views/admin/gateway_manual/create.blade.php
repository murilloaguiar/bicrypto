            ...
            <div class="card">
                <form action="{{ route('admin.gateway.manual.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <img class="img-thumbnail mb-1" src="{{getImage(imagePath()['gateway']['path'],imagePath()['gateway']['size'])}}">
                                ...
                                <div class="col-lg-9">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-15">
                                            <div class="mb-2">
                                                <label class="h6">{{ __('locale.Gateway Name')}} <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" placeholder="{{ __('locale.Method Name')}}" name="name" value="{{ old('name') }}"/>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-15">
                                            <div class="mb-2">
                                                <label class="h6">{{ __('locale.Currency')}} <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="currency" placeholder="{{ __('locale.Currency')}}" value="{{ old('currency') }}"/>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-15">
                                            <label class="h6">{{ __('locale.Rate')}} <span class="text-danger">*</span></label>
                                            <div class="input-group mb-2">
                                                <span class="input-group-text" id="basic-addon1">1 {{ __($general->cur_text )}} =</span>
