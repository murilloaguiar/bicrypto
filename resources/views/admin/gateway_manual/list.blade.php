        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title">Manual Gateways</h4><div class="card-search"></div>
                </div>
                <div class="table-responsive">
                    <table class="table table-hover custom-data-bs-table">
                        <thead class="table-dark">
                            <tr>
                                <th scope="col">{{ __('locale.Gateway')}}</th>
                            ...
                            @forelse($gateways as $gateway)
                                <tr>
                                    <td data-label="{{ __('locale.Gateway')}}">
                                    ...
                                    <td data-label="{{ __('locale.Action')}}">
                                        ...
                                        <button  class="btn btn-icon btn-warning btn-sm editGatewayBtn" data-bs-toggle="tooltip" title="{{ __('locale.Edit')}}" data-original-title="{{ __('locale.Edit')}}">
...
@push('breadcrumb-plugins')
    <a class="btn btn-primary" href="{{ route('admin.gateway.manual.create') }}"><i class="bi bi-plus"></i>{{ __('locale.Add new')}}</a>
@endpush
@push('script')
    <script>
