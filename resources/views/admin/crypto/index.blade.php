...
<section id="basic-datatable">
    ...
    <div class="modal modal-slide-in fade" id="updateModal">
        <div class="modal-dialog sidebar-sm">
          <form class="add-new-record modal-content pt-0" action="{{route('admin.crypto.update')}}" method="POST" enctype="multipart/form-data">
              @csrf
...
<div id="deleteModal" class="modal fade text-start" tabindex="-1" aria-hidden="true" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.crypto.delete') }}" method="POST">
                @csrf
    ...
    $(function () {
        ...
        if (dt_basic_table.length) {
            var dt_basic = dt_basic_table.DataTable({
                ajax: assetPath + 'data/coinlist.json',
                columns: [
                    {data: 'responsive_id'},
                    {data: 'id'},
            ...
            $('div.head-label').html('<h6 class="mb-0">Coin Manager</h6>');
        }
