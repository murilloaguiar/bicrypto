            ...
            <div class="card rounded-2 overflow-hidden shadow">
                <div class="card-body">
                    ...
                    @if($withdrawal->status == 2)
                        <div class="row mt-2">
                            <div class="col-md-12">
                                <button class="btn btn-success ms-1 approveBtn" data-bs-toggle="tooltip" data-original-title="@lang('Approve')"
                                ...
                                <button class="btn btn-danger ms-1 rejectBtn" data-bs-toggle="tooltip" data-original-title="@lang('Reject')"
