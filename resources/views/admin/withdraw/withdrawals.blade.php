                                ...
                                <tr>
                                    ...
                                    @if(request()->routeIs('admin.withdraw.pending'))
                                        ...
                                        <td data-label="{{ __('locale.Action')}}">
                                            <a href="{{ route('admin.withdraw.details', $withdraw->id) }}" class="btn btn-icon btn-info  btn-sm " data-bs-toggle="tooltip"data-original-title="{{ __('locale.Detail')}}">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                        </td>
                                    ...
                                    @if(request()->routeIs('admin.withdraw.approved') || request()->routeIs('admin.withdraw.rejected'))
                                        <td data-label="@lang('Info')">
                                            <a href="{{ route('admin.withdraw.details', $withdraw->id) }}" class="btn btn-icon btn-info ms-1 " data-bs-toggle="tooltip" data-original-title="{{ __('locale.Detail')}}">
