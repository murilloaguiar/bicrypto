                                ...
                                <tr>
                                    ...
                                    <td data-label="{{ __('locale.Action')}}">
                                        <a href="{{ route('admin.withdraw.method.edit', $method->id)}}">
                                            <button class="btn btn-icon btn-warning btn-sm" data-bs-toggle="tooltip" data-original-title="{{ __('locale.Edit')}}"><i class="bi bi-pen"></i> </button>
                                        </a>
                                        @if($method->status == 1)
                                            <button href="javascript:void(0)" class="btn btn-icon btn-danger btn-sm deactivateBtn" data-bs-toggle="tooltip" data-original-title="{{ __('locale.Disable')}}" data-id="{{ $method->id }}" data-name="{{ __($method->name) }}">
                                                <i class="bi bi-eye-slash"></i>
                                            </button>
                                        @else
                                            <button href="javascript:void(0)" class="btn btn-icon btn-success btn-sm activateBtn"
                                               data-bs-toggle="tooltip" data-original-title="@lang('Enable')"
