                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <button class="btn btn-success ms-1 approveBtn"
                                        ...
                                        data-bs-toggle="tooltip" data-original-title="{{ __('locale.Approve')}}"><i class="fas fa-check"></i>
                                    {{ __('locale.Approve')}}
                                </button>
                                ...
                                <button class="btn btn-danger ms-1 rejectBtn"
                                        ...
                                        data-amount="{{ getAmount($deposit->amount)}} {{ __($general->cur_text) }}"
                                        data-username="{{ @$deposit->user->username }}"
                                        data-bs-toggle="tooltip" data-original-title="{{ __('locale.Reject')}}"><i class="fas fa-ban"></i>
                                    {{ __('locale.Reject')}}
                                </button>
                            </div>
                        </div>
